...
dispatcher.bulk_append_widgets([
    ...
    Launcher(format=Icons.telegram, command='telegram-desktop',
             separator=False, color='#6688ff'),
    Launcher(format=Icons.terminal, command='alacritty',
             color='#00FF00', separator=False),
    Launcher(format=Icons.notebook_pen, command='xournalpp', color='#CC2222'),
